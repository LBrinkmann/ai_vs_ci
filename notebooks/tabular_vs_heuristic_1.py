...
# %%
w = (
    (final_smooth_dfm['label.eps'] == 'decay') &
...
sns.relplot(
    ...
    x='episode', 
    y='value', 
    row='label.controller_args', 
    col="label.networktype",  
    hue="label.rewards", 
    kind="line", 
    row_order=controller_args_order, 
    col_order=networktype_order, 
    hue_order=rewards_order,
    style='variable',
    ci=None
)
...
w = (
    (binned_trace_dfm['label.rewards'] == 'mixed') &
