#PBS -N project_ai_vs_ci__batch_test_djx_heuristic__self_weight_0.0__n_agents_2__networktype_nondense
#PBS -l walltime=4:0:0
#PBS -l mem=2gb
#PBS -j oe
#PBS -o runs/djx_test_heu/project_ai_vs_ci__batch_test_djx_heuristic__self_weight_0.0__n_agents_2__networktype_nondense/log.log
#PBS -m n
#PBS -d .
